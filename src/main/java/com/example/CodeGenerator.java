...
public class CodeGenerator {
     ...
     * author
     */
    private static final String AUTHOR = "cheng.zhang";
     ...
     * 表名，多个表用英文逗号分隔
     */
    private static final String TABLES = "nft_group";
     ...
     * 数据库连接地址
     */
    private static final String URL = "jdbc:mysql://101.201.46.114:3306/ido_server?useUnicode=true&useSSL=false&characterEncoding=utf8";
     ...
     * 数据库用户名
     */
    private static final String USERNAME = "crypto_rw";

    /**
     * 数据库密码
     */
    private static final String PASSWORD = "crypto_rw_password";
